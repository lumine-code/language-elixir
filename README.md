...
To install `language-elixir` search for _language-elixir_ in the Install pane of the Lumine settings or run `lumine --install lumine-code/language-elixir`.

## Services

- **hyperlink.injection** (`^1.0.0`): consumed to highlight URLs inside Elixir files as clickable links.
